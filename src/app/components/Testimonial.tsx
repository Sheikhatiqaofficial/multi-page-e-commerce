            ...
            <div className="container pt-16 pb-16 grid-cols-2">
                ...
                <div className="grid lg:grid-cols-[300px,1fr] gap-4">
                    <div className="border border-gray-300 rounded-2xl grid place-items-center p-6 lg:p-0">
                        <div className="text-container flex flex-col items-center gap-1">
<Image
...
Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus explicabo accusamus quos.
</p>
                        </div>
...
<div className="bg-[#ffffffab] main-w-[270px] sm:min-w-[300px] md:min-w-[500px] rounded-xl py-8 sm:px-8 px-2 grid place-items-center gap-3">
    <button className="bg-blackishtext-white p-2 rounded-md">
        25% DISSCOUNT
    </button>
